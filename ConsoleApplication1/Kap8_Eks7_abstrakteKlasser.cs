...
namespace ConsoleApplication1
{
    public abstract class Dyr
    {
        ...
        public virtual string Lyd()
        // "virtual" betyder, at det er muligt at skrive en ny version i subklassen
        {
            return "Jeg er et uspecificeret dyr og kan ikke sige noget";
        }
